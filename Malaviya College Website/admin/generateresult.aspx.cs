...
public partial class admin_generateresult : System.Web.UI.Page
{
    string sid = "", syear = "", em = "", state="";
    int rollno;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        con.Close();
        con.Open();
        com.CommandText = "select * from pmarks where stud_id=" + sid + " And stud_year='" + syear + "'";
        com.Connection = con;
        reader = com.ExecuteReader();
    ...
    protected void addstd(object sender, EventArgs e)
    {
        if (state == "update")
        {
            //if (!Page.IsPostBack)
            {
                ...
                else if (syear == "Second Year")
                {
                    ...
                    com.CommandText = "update pmarks set english='" + Emarks.Text + "',Businesseconomics='" + Eecomarks.Text + "',FinancialAccounting='" + EAccomarks.Text + "',CompanyLaw='" + ELawmarks.Text + "',BusinessAdm='" + EAdmmarks.Text + "',FE_ME_IT='" + Eoptmarks.Text + "',MATHS_SSP='" + EMATmarks.Text + "',GRANDTOTAL='" + tmarks + "',percentage='" + (tmarks * 100) / 800 + "'  where stud_id=" + sid;
                ...
                //tmarks = Convert.ToInt32(Emarks.Text) + Convert.ToInt32(Eecomarks.Text) + Convert.ToInt32(EAccomarks.Text) + Convert.ToInt32(ELawmarks.Text) + Convert.ToInt32(EAdmmarks.Text) + Convert.ToInt32(Eoptmarks.Text) + Convert.ToInt32(EMATmarks.Text) + Convert.ToInt32(OEMATmark.Text);
                //com.CommandText = "update pmarks set english='" + Emarks.Text + "',Businesseconomics='" + Eecomarks.Text + "',FinancialAccounting='" + EAccomarks.Text + "',CompanyLaw='" + ELawmarks.Text + "',BusinessAdm='" + EAdmmarks.Text + "',FE_ME_IT='" + Eoptmarks.Text + "',MATHS_SSP='" + EMATmarks.Text + "',Opt='" + OEMATmark.Text + "',GRANDTOTAL='" + tmarks + "'  where stud_id=" + sid;
                com.Connection = con;
                int i = com.ExecuteNonQuery();
                //Response.Write("update termmarks set english='" + Emarks.Text + "',Businesseconomics='" + Eecomarks.Text + "',FinancialAccounting='" + EAccomarks.Text + "',CompanyLaw='" + ELawmarks.Text + "',BusinessAdm='" + EAdmmarks.Text + "',FE_ME_IT='" + Eoptmarks.Text + "',MATHS_SSP='" + EMATmarks.Text + "',Opt='" + OEMATmark.Text + "','" + tmarks + "','" + Convert.ToInt32(sid) + "','" + syear + "' where stud_id=" + sid);
                con.Close();
        ...
        else
        {
            ...
            {
                tmarks = Convert.ToInt32(Emarks.Text) + Convert.ToInt32(Eecomarks.Text) + Convert.ToInt32(EAccomarks.Text) + Convert.ToInt32(ELawmarks.Text) + Convert.ToInt32(EAdmmarks.Text) + Convert.ToInt32(Eoptmarks.Text) + Convert.ToInt32(EMATmarks.Text) + Convert.ToInt32(OEMATmark.Text);
                com.CommandText = "insert into pmarks values('" + Emarks.Text + "','" + Eecomarks.Text + "','" + EAccomarks.Text + "','" + ELawmarks.Text + "','" + EAdmmarks.Text + "','" + Eoptmarks.Text + "','" + EMATmarks.Text + "','" + OEMATmark.Text + "','" + tmarks + "','" + Convert.ToInt32(sid) + "','" + syear + "','" + rollno + "','" + (tmarks * 100) / 800 + "')";
            ...
            {
                tmarks = Convert.ToInt32(Emarks.Text) + Convert.ToInt32(Eecomarks.Text) + Convert.ToInt32(EAccomarks.Text) + Convert.ToInt32(ELawmarks.Text) + Convert.ToInt32(EAdmmarks.Text) + Convert.ToInt32(Eoptmarks.Text) + Convert.ToInt32(EMATmarks.Text);
                com.CommandText = "insert into pmarks values('" + Emarks.Text + "','" + Eecomarks.Text + "','" + EAccomarks.Text + "','" + ELawmarks.Text + "','" + EAdmmarks.Text + "','" + Eoptmarks.Text + "','" + EMATmarks.Text + "','','" + tmarks + "','" + Convert.ToInt32(sid) + "','" + syear + "','" + rollno + "','" + (tmarks * 100) / 800 + "')";
            ...
            {
                tmarks = Convert.ToInt32(Emarks.Text) + Convert.ToInt32(Eecomarks.Text) + Convert.ToInt32(EAccomarks.Text) + Convert.ToInt32(ELawmarks.Text) + Convert.ToInt32(EAdmmarks.Text) + Convert.ToInt32(Eoptmarks.Text) + Convert.ToInt32(EMATmarks.Text);
                com.CommandText = "insert into pmarks values('" + Emarks.Text + "','" + Eecomarks.Text + "','" + EAccomarks.Text + "','" + ELawmarks.Text + "','" + EAdmmarks.Text + "','" + Eoptmarks.Text + "','" + EMATmarks.Text + "','','" + tmarks + "','" + Convert.ToInt32(sid) + "','" + syear + "','" + rollno + "','" + (tmarks * 100) / 850 + "')";
            }
            //tmarks = Convert.ToInt32(Emarks.Text) + Convert.ToInt32(Eecomarks.Text) + Convert.ToInt32(EAccomarks.Text) + Convert.ToInt32(ELawmarks.Text) + Convert.ToInt32(EAdmmarks.Text) + Convert.ToInt32(Eoptmarks.Text) + Convert.ToInt32(EMATmarks.Text) + Convert.ToInt32(OEMATmark.Text);
            //com.CommandText = "insert into pmarks values('" + Emarks.Text + "','" + Eecomarks.Text + "','" + EAccomarks.Text + "','" + ELawmarks.Text + "','" + EAdmmarks.Text + "','" + Eoptmarks.Text + "','" + EMATmarks.Text + "','" + OEMATmark.Text + "','" + tmarks + "','" + Convert.ToInt32(sid) + "','" + syear + "','"+rollno+"')";
            com.Connection = con;
            int i = com.ExecuteNonQuery();
            //Response.Write("insert into collegestudents values('" + StudentName.Text + "','" + Surname.Text + "','" + FatherName.Text + "','" + AcademicYear.Text + "','" + Studyear.SelectedItem + "')");
            con.Close();
            Response.Redirect("studentsyear.aspx?em=" + em + "gtres1x1dfrsdgh");
        }
    }
