...
public partial class admin_ManageSubjArticle : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            cmd.CommandText = "select * from journalTopic";
            cmd.Connection = cnn;
    ...
    protected void evaluate(object sender, GridViewCommandEventArgs eg)
    {
        ...
        {
            cnn.Open();
            cmd.CommandText = "delete from [journalTopic] where jid=" + eg.CommandArgument;
            cmd.Connection = cnn;
