<%@ Page Title="" Language="C#" MasterPageFile="AdminPage.master" AutoEventWireup="true" CodeFile="EditContent.aspx.cs" Inherits="EditContent" %>
<%@ Register Assembly="CKEditor.NET" Namespace="CKEditor.NET" TagPrefix="CKEditor" %> 
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
<div class="contenthead">Edit Page</div>
...
<div class="PageDetailadd">Edit Content</div>
        ...
        <div class="pgright">
            ...
            <asp:RequiredFieldValidator ID="RequiredDescriptionbox" runat="server" ErrorMessage="*" ControlToValidate="Descriptionbox"></asp:RequiredFieldValidator></div>    
